...
//                out.println(course_name+"\n"+total);
                if(course_name!=null)
                {
                    ...
                    String qr="select studinfo.username, student.username, fname,lname,attended,total from studinfo,student where student.username=studinfo.username and course_name=?";
