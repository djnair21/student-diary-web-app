...
<html>
   <head>
    ...
    <body>
        <%
     String student_username = (String)request.getParameter("username");
       if(student_username!=null)
        session.setAttribute("uname", student_username);
        else
        	student_username = (String)session.getAttribute("uname");
  ...
  <li><a href="index.jsp">Sign Out</a>
                    ...
                    <%
                    //student_username = request.getParameter("student_username");
