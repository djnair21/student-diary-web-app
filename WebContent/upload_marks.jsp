...
//                out.println(course_name+"\n"+total);
            ...
            <%
                if(course_name!=null)
                {
                    ...
                    String qr="select studinfo.username, student.username, fname,lname from studinfo,student where student.username=studinfo.username and course_name=?";
            ...
            %>
                        <tr>
                            <td class="s"><%=rs1.getString("username")%></td>
                            <td>
            ...
            <input type="submit" onclick="update('c','s');" value="Update">
             &nbsp
             <input type="submit" onclick="callReport();" value=" Generate Report">
...
var course = '<%= (String)request.getParameter("course_name") %>';
 function callReport()
            {
                
                window.location.replace("report?course_name="+course);
